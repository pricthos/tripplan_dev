...
const PlanChallengeEndedDetail: React.FC = () => {
    const { planId, challengeId } = useParams<{ planId: string, challengeId: string }>();
    ...
    if (!plan) {
        return (
            <div className="text-center text-white py-20">
                ...
                <Link to={`/app/plan-challenge/ended/${challengeId}`} className="mt-4 inline-block text-blue-400 hover:underline">결과 목록으로 돌아가기</Link>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-[1100px] mx-auto">
            <div className="mb-8">
                <Link to={`/app/plan-challenge/ended/${challengeId}`} className="inline-flex items-center text-sm text-blue-400 hover:text-blue-300 transition-colors">
            ...
            <div className="flex flex-col lg:flex-row lg:gap-8 xl:gap-12">
                <main className="w-full lg:w-2/3 space-y-8">
                    ...
                    >
                        ...
                        <div className="absolute bottom-6 right-6 bg-black/50 backdrop-blur-sm text-white px-4 py-2 rounded-lg flex items-center gap-2">
                            <ThumbsUp className="w-5 h-5 text-yellow-300" />
                            <span className="font-bold text-lg">{plan.votes}</span>
                            <span className="text-sm text-gray-300">추천</span>
                        </div>
                    </div>
...
export default PlanChallengeEndedDetail;